...
\bottomrule
\end{tabular}
\caption{在摘要数据集 CNN/Daily Mail、arXiv、PubMed、MediaSum 和 MultiNews，翻译数据集 WMT，以及问答数据集 TriviaQA 上，采用 multi-head 注意力的 T5 Large 和 XXL 模型，与经过 5\% 继续训练、采用 multi-query 和 grouped-query 注意力的 T5-XXL 模型，在推理时间和平均开发集性能方面的比较。}
